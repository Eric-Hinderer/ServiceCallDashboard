...
const RealTimeData = () => {
  ...
  return (
    <div className="p-4 md:p-8">
      <h2 className="text-xl font-semibold mb-6 text-center">Real-time Service Calls</h2>
        ...
        {realTimeData.map((serviceCall) => (
          <div key={serviceCall._id.toString()} className="border border-gray-200 rounded-lg shadow-md p-6 bg-white">
            ...
            <div className="mt-2 space-y-2">
              ...
              <div>
                <strong>Taken By:</strong> <TakenBy id={serviceCall._id.toString()} currentTakenBy={serviceCall.takenBy} />
              </div>
              <div>
                <strong>Notes:</strong>
                <div className="text-sm text-gray-700 max-w-xs break-words">{serviceCall.notes || "N/A"}</div>
              </div>
              <div>
